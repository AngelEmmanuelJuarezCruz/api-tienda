...
Route::middleware(['auth', 'role:encargado,dueno,administrador'])->prefix('almacen')->group(function () {
    ...
    Route::get('/alertas', [\App\Http\Controllers\DashboardController::class, 'alertas'])->name('almacen.alertas');

    // Productos (CRUD minimal)
    Route::get('/productos', [\App\Http\Controllers\DashboardController::class, 'productos'])->name('almacen.productos');
