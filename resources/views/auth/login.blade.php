...
<body class="min-h-screen flex items-center justify-center bg-[#F2F4F7] font-sans">
    <main class="w-full max-w-md p-6">
        <section class="bg-white shadow-lg rounded-xl p-8">
            <header class="mb-8 text-center">
                <div class="mx-auto mb-4 w-16 h-16 flex items-center justify-center rounded-lg bg-[#E6EEF8]">
                    <!-- Medical cross icon -->
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-[#1E3A8A]" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            ...
            <form id="loginForm" method="POST" action="{{ route('login.post') }}" novalidate>
                ...
                <div class="mb-5">
                    ...
                    <input
                        ...
                        class="block w-full px-4 py-2.5 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#1E3A8A] focus:border-[#1E3A8A] transition-colors
                ...
                <div class="mb-5">
                    ...
                    <div class="relative">
                        ...
                        <button
                            ...
                            class="absolute inset-y-0 right-1 flex items-center px-3 text-gray-500 hover:text-gray-700 focus:outline-none"
                        >
                ...
                <div class="flex items-center justify-between mb-6">
                    <div class="flex items-center">
                        <input id="remember" name="remember" type="checkbox" class="h-4 w-4 text-[#1E3A8A] border-gray-300 rounded focus:ring-[#1E3A8A]" />
                        <label for="remember" class="ml-2 block text-sm text-gray-600">Recordarme</label>
                    </div>
                    <div>
                        <a href="#" class="text-sm text-[#1E3A8A] font-medium hover:underline">¿Olvidaste tu contraseña?</a>
                    </div>
                </div>
                ...
                <div>
                    <button
                        id="submitBtn"
                        type="submit"
                        class="w-full inline-flex items-center justify-center px-4 py-3 bg-[#1E3A8A] hover:bg-[#162f66] text-white font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#1E3A8A] disabled:opacity-50 transition-colors"
                    >
