                    ...
                    <tr class="hover:bg-slate-50 transition-colors">
                        ...
                        <td class="px-6 py-4 text-center whitespace-nowrap text-sm font-medium">
                            <div class="flex items-center justify-center gap-3">
                                <a href="{{ route('almacen.productos.show', $producto) }}" class="inline-flex items-center gap-1 bg-blue-50 text-blue-700 hover:text-blue-800 hover:bg-blue-100 transition-colors px-3 py-1.5 rounded-lg text-xs font-bold shadow-sm border border-blue-200" title="Ver Historial de Movimientos">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01" />
                                    </svg>
                                    Historial
                                </a>
                                <a href="{{ route('almacen.productos.edit', $producto) }}" class="inline-flex items-center gap-1 bg-yellow-50 text-yellow-700 hover:text-yellow-800 hover:bg-yellow-100 transition-colors px-3 py-1.5 rounded-lg text-xs font-bold shadow-sm border border-yellow-200" title="Editar Producto">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536M16.732 3.732a2.5 2.5 0 113.536 3.536L7 20.5H3v-4L16.732 3.732z" />
                                    </svg>
                                    Editar
                                </a>
                                <form action="{{ route('almacen.productos.destroy', $producto) }}" method="POST" onsubmit="return confirm('¿Eliminar o desactivar este producto?');" class="inline-flex">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="inline-flex items-center gap-1 bg-red-50 text-red-700 hover:text-red-800 hover:bg-red-100 transition-colors px-3 py-1.5 rounded-lg text-xs font-bold shadow-sm border border-red-200" title="Eliminar Producto">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862A2 2 0 015.867 19.142L5 7m5 4v6m4-6v6M9 7V4h6v3m-9 0h12" />
                                        </svg>
                                        Eliminar
                                    </button>
                                </form>
