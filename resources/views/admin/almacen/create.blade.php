...
@section('content')
<div class="bg-white rounded-lg shadow-2xl p-8 max-w-4xl mx-auto mt-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <input type="text" name="nombre" value="{{ old('nombre') }}" required
                       class="w-full rounded-lg border border-gray-300 p-3 focus:outline-none focus:ring-2 focus:ring-[#1E3A8A] focus:shadow-md transition"
            ...
            <div>
                ...
                <select name="categoria_id" class="w-full rounded-lg border border-gray-300 p-3 focus:outline-none focus:ring-2 focus:ring-[#1E3A8A] transition">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" name="precio_venta" value="{{ old('precio_venta') }}" step="0.01" required
                           class="w-full rounded-lg border border-gray-300 p-3 pl-8 focus:outline-none focus:ring-2 focus:ring-[#1E3A8A] focus:shadow-md transition"
                           placeholder="0.00">
                </div>
                @error('precio_venta')
                    <p class="text-sm text-red-600 mt-1">{{ $message }}</p>
